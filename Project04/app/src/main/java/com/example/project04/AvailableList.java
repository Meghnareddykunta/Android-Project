...
public class AvailableList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ridecollection = db.collection("lookforride");
        ...
        ridecollection.orderBy("Username", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    rideLayoutManager = new LinearLayoutManager(AvailableList.this);
                    rideAdapter = new RidelistAdapter(itemListArray, AvailableList.this);
