...
public class LookForRideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemCollection = db.collection("lookforride");
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(LookForRideActivity.this,"Your ride has been requested",Toast.LENGTH_LONG).show();
            }
        });
    }
}
