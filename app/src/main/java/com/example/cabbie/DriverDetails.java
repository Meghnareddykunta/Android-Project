...
public class DriverDetails implements Serializable {
    ...
    public DriverDetails(String name, String fromAddress, String toAddress, String fromCity, String fromState, String fromZipCode, String toCity, String toState, String toZipCode, String date, String time, int resId, String phone) {
        this.name = name;
